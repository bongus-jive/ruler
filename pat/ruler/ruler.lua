...
local rulerEnabled, gridEnabled, aimPosition
...
function init()
	...
	message.setHandler("pat_ruler_toggle", localHandler(function()
		rulerEnabled = not rulerEnabled
		player.setProperty("pat_ruler_enabled", rulerEnabled)
		return rulerEnabled
	end))
	
	message.setHandler("pat_tilegrid_toggle", localHandler(function()
